...
namespace GPUDrivenGrassDemo.Runtime
{
    ...
    public class Tool
    {
        ...
        public static void SaveRTToEXR(RenderTexture renderTexture, string filePath)
        {
            Texture2D texture = new Texture2D(renderTexture.width, renderTexture.height, TextureFormat.RFloat, false);
